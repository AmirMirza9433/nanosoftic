            ...
            <div className="flex gap-3 mt-4">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-[var(--surface-soft)] border border-[var(--surface-border-subtle)] flex items-center justify-center text-foreground-muted hover:text-accent-cyan hover:border-accent-cyan transition-colors"
                >
                  {link.icon}
                </a>
              ))}
